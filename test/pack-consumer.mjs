/**
 * Simulates a published tarball: minimal install must resolve `@claw_wallet_sdk/claw_wallet`
...
try {
  ...
  writeFileSync(
    ...
    `import { createClawWalletClient, ClawSandboxClient } from "@claw_wallet_sdk/claw_wallet";
...
`,
  ...
  writeFileSync(
    ...
    `import { createClawSandboxPublicClient } from "@claw_wallet_sdk/claw_wallet/viem";
...
`,
  ...
  writeFileSync(
    ...
    `import { createClawSandboxJsonRpcProvider } from "@claw_wallet_sdk/claw_wallet/ethers";
